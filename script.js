...
function filterPokemon(searchTerm, typeFilters) {
    ...
    // Apply filter by search term in the name
    filteredPokemon = filteredPokemon.filter((pokemon) => {
...
function createPokemonCard(pokemon) {
    ...
    // Add class based on Pokémon types
    if (pokemon.type.length === 2) {
        card.classList.add(`${pokemon.type[0].toLowerCase()}-${pokemon.type[1].toLowerCase()}`);
    } else {
        card.classList.add(pokemon.type[0].toLowerCase());
    }
    ...
    // Create a button as the Pokémon image
    ...
    for (let i = 0; i < pokemon.type.length; i++) {
        ...
        typeImage.alt = `${pokemon.type[i]} type`;
    ...
    imageButton.addEventListener("click", () => {
        togglePokemonSound(pokemon.name);
    });
...
function getTypeImageURL(type) {
    const typeToImage = {
        ...
        Fantasma: "https://upload.wikimedia.org/wikipedia/commons/8/8a/Fantasma_Pokemon.svg",
        Bicho: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/fa/Bicho_Pokemon.svg/2560px-Bicho_Pokemon.svg.png",
        Lucha: "https://upload.wikimedia.org/wikipedia/commons/1/1a/Lucha_Pokemon.svg",
        Volador: "https://upload.wikimedia.org/wikipedia/commons/9/9d/Volador_Pokemon.svg",
        Psíquico: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b7/Ps%C3%ADquico_Pokemon.svg/2560px-Ps%C3%ADquico_Pokemon.svg.png",
        Dragón: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a8/Drag%C3%B3n_Pokemon.svg/1200px-Drag%C3%B3n_Pokemon.svg.png",
        Hada: "https://upload.wikimedia.org/wikipedia/commons/5/50/Hada_Pokemon.svg",
        Planta: "https://upload.wikimedia.org/wikipedia/commons/f/f2/Planta_Pokemon.svg",
        Fuego: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a6/Fuego_Pokemon.svg/2560px-Fuego_Pokemon.svg.png",
        Agua: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/36/Agua_Pokemon.svg/2560px-Agua_Pokemon.svg.png",
        Siniestro: "https://upload.wikimedia.org/wikipedia/commons/2/23/Siniestro_Pokemon.svg",
        Hielo: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/77/Hielo_Pokemon.svg/2560px-Hielo_Pokemon.svg.png",
        Tierra: "https://upload.wikimedia.org/wikipedia/commons/4/43/Tierra_Pokemon.svg",
        Roca: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/46/Roca_Pokemon.svg/2560px-Roca_Pokemon.svg.png",
        Veneno: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e7/Veneno_Pokemon.svg/2560px-Veneno_Pokemon.svg.png",
        Normal: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9d/Normal_Pokemon.svg/2560px-Normal_Pokemon.svg.png",
        Acero: "https://upload.wikimedia.org/wikipedia/commons/2/2e/Acero_Pokemon.svg",
        // Add more type mappings here
    };

    return typeToImage[type] || "default.png"; // Provide a default image if type not found
}
