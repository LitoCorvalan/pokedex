...
// Marca un contenedor como "cargando" hasta que su imagen termine de cargar.
// El spinner (pokebola) lo dibuja CSS con la clase .img-loading.
function attachImageSpinner(img, host) {
